...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    description: "Śrīla Prabhupāda's books — read free on Vedabase or get them from the official BBT store.",
    alternates: localizedAlternates(locale, "/books"),
  };
}
...
// Vedabase and store; the "spines" are typographic, no cover artwork. Book
// titles/subtitles are catalog content (like category names), left
// untranslated - only the page chrome around them is localized.
